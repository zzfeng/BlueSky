...
/**
 * picasso 缓存位置 /data/data/<application package>/cache/picasso-cache/
 *
...
public class DataCleanManager {
    ...
    public static String getCacheSize(Context context) {
        ...
        try {
            innerCacheSize = getFolderSize(context.getCacheDir());
            if (Environment.getExternalStorageState().equals(
                    Environment.MEDIA_MOUNTED)) {
            ...
            e.printStackTrace();
            throw new RuntimeException("获取缓存大小失败");
        }
        return getFormatSize(innerCacheSize + externalCacheSize);
    }
