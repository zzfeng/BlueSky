...
public class AllSiteMapModel extends BaseModel {
    ...
    public AllSiteMapModel(Context ctx, BaiduMap mBaiduMap) {
        super(ctx);
    ...
    public ArrayList<BrokeBuildBean.Build> getSearchData(LatLng myLocation,
        ...
        for (BrokeBuildBean.Build build : bulidList) {
            try {
                if (Double.valueOf(build.latitude) > MinWD
                        && Double.valueOf(build.latitude) < MaxWD
                        && Double.valueOf(build.longitude) > MinJD
                        && Double.valueOf(build.longitude) < MaxJD) {
